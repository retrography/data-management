...
Final project (team)
2 Quizzes
2 Exercises (individual) Attendance and Participation
Final project (team)
40% 30% 20% 10%
...
Course Schedule
Course schedule will be shared with you on the first day of the class. One session over two will be in form of a workshop and will cover technical material. Each session requires you to read one or two texts. For some topics you will also have some news articles to skim in order to warm up the class discussion.
40%
￼￼￼￼INSY 437/638 Syllabus Winter 2015 p.3
￼￼The workload will be lighter when large deliverables are due. We will kickstart the final project on Feb. 24 with a final delivery date of Apr. 10.
University Policies
